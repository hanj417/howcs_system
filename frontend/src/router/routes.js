...
export default [
  ...
  },
  {
    ...
    children: [
      { path: 'classes/:state/major_category/:major_category/minor_category/:minor_category', name: 'class_minor_list', component: () => import('pages/ClassList'), props: true },
      { path: 'classes/:state/major_category/:major_category', name: 'class_major_list', component: () => import('pages/ClassList'), props: true },
      { path: 'class_teacher/:teacher_id/:major_category/:action', name: 'class_teacher', component: () => import('pages/ClassList'), props: true },
      { path: 'class_teacher/:teacher_id/:major_category/:minor_category/:action', name: 'howcs_class_teacher', component: () => import('pages/ClassList'), props: true },
      ...
      { path: 'new_post', name: 'new_post', component: () => import('pages/NewPost'), props: true },
      ...
      { path: 'attendances/students/:student_id/:class_id', name: 'attendance_student', component: () => import('pages/AttendanceStudent'), props: true },
       { path: 'payment', name: 'payment', component: () => import('pages/Payment'), props: true },
       { path: 'payment_form_new', name: 'payment_form_new', component: () => import('pages/PaymentForm'), props: true },
       { path: 'payment_form_edit', name: 'payment_form_edit', component: () => import('pages/PaymentForm'), props: true },
