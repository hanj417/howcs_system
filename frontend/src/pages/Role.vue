  ...
  data: function () {
    return {
      ...
      columns: [
        ...
        { name: 'howcs_student_fruit_record', label: '하우열매조회', field: 'howcs_student_fruit_record', align: 'center' },
        { name: 'howcs_student_fruit_record_new', label: '하우열매생성', field: 'howcs_student_fruit_record_new', align: 'center' },
        { name: 'howcs_student_fruit_record_update', label: '하우열매수정', field: 'howcs_student_fruit_record_update', align: 'center' },
        { name: 'howcs_student_fruit_record_del', label: '하우열매삭제', field: 'howcs_student_fruit_record_del', align: 'center' },
      ...
      visible_columns: [
        ...
        'howcs_student_fruit_record',
        'howcs_student_fruit_record_new',
        'howcs_student_fruit_record_update',
        'howcs_student_fruit_record_del',
        'howcs_post',
        'howcs_post_new',
        'howcs_post_update',
        'howcs_post_del',
